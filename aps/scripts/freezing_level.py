...
hour_range = [24, 48]
date_str = '20190308T00Z'
var_fl = 'altitude_of_isoTprimW_equal_0' # "altitude_of_0_degree_isotherm"
var_rr = 'precipitation_amount'
tmp_folder = Path(r'./tmp')

nc_file1 = r"\\hdata\grid\metdata\prognosis\meps\det\archive\2019\meps_det_extracted_1km_{0}.nc".format(date_str)
times, altitude, land_area_fraction, nc_vars = ga.nc_load(nc_file1, [var_fl], time_period=hour_range)
